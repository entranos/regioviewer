...
function drawSelectionButtons (config) {
  ...
  // SET DEFAULTS
  globalActiveScenario.id = 'groningen'
  globalActiveYear.id = '2040'
  ...
  function setScenario (scenario, type) {
    // Note: Menu visibility observer is currently disabled for performance reasons
    ...
    // update all sankeys
    // console.log(sankeyInstances) // Commented out for performance
  ...
  const colorProvincie = '#FFFFFF'

  drawScenarioButtons_sankey()
  function drawScenarioButtons_sankey () {
    let scenarios = [

      {id: 'groningen', title: 'Groningen', color: colorProvincie},
      {id: 'friesland', title: 'Friesland', color: colorProvincie},
      {id: 'drenthe', title: 'Drenthe', color: colorProvincie},
      {id: 'overijssel', title: 'Overijssel', color: colorProvincie},
      {id: 'flevoland', title: 'Flevoland', color: colorProvincie},
      {id: 'gelderland', title: 'Gelderland', color: colorProvincie},
      {id: 'utrecht', title: 'Utrecht', color: colorProvincie},
      {id: 'noordholland', title: 'Noord-Holland', color: colorProvincie},
      {id: 'zuidholland', title: 'Zuid-Holland', color: colorProvincie},
      {id: 'zeeland', title: 'Zeeland', color: colorProvincie},
      {id: 'noordbrabant', title: 'Noord-Brabant', color: colorProvincie},
      {id: 'limburg', title: 'Limburg', color: colorProvincie},
     
    ]

    let container = document.getElementById('scenarioButtons_sankey')
    container.innerHTML = ''

    // Add label
    let label = document.createElement('div')
    label.className = 'menu-label'
    label.textContent = 'Provincie'
    ...
    scenarios.forEach((scenario, index) => {
      ...
      createButton_sankey(button, -1) // Pass -1 to prevent default highlighting
      ...
      button.onclick = function () {
        ...
        const yearButtonsContainer = document.getElementById('yearButtons_sankey');
        const yearButtons_sankey = yearButtonsContainer.getElementsByTagName('button');

        Array.from(yearButtons_sankey).forEach((button, index) => {
  ...
  drawYearButtons_sankey()
  function drawYearButtons_sankey () {
    let years = [ 
      // {id: '2025', title: '2025'},
      // {id: '2030', title: '2030'},/
      // {id: '2035', title: '2035'},
    ...
    let container = document.getElementById('yearButtons_sankey')
    container.innerHTML = ''
    ...
    years.forEach((year, index) => {
      ...
      function updateButtonState_sankey() {
...
function updateButtonStates_sankey() {
...
function drawSankeyEnergiestromenSelectieButtons () {
  ...
  focusOptions.forEach((focus, index) => {
    ...
    createButton_sankey(button, index)
...
function createButton_sankey(button, index) {
