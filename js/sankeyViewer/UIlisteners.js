...
const resizeObserver = new ResizeObserver((entries) => {
  for (let entry of entries) {
    ...
    // Check if sankeyConfigs is defined before using it
    if (typeof sankeyConfigs !== 'undefined' && sankeyConfigs.length > 0) {
    ...
    d3.select('#menuContainer2').style('top', document.getElementById('menuContainer_sankey').offsetHeight + 'px')
  }
})
